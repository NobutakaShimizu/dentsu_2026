...
<div class="text-slate-500">
  2026年9月24〜26日, 最適化・計算機科学・代数幾何@電気通信大学
</div>
...
- 行列積の近似と誤り訂正に関する研究
- STOC, ICALP, FOCSに採択
  - **STOC, FOCS**: 理論計算機科学分野のすごい国際会議
  - 色んな数学（主に組合せ論）の道具をコンピュータサイエンスの理論に応用
    - 加法的組合せ論、エクスパンダー、誤り訂正符号（上記の論文ではこれら全部使ってる）
...
- [Strassen (1968)](https://link.springer.com/article/10.1007/BF02165411)によって $O(n^{2.807})$時間アルゴリズムが与えられた
- 以降、現在も「右肩」の改善が続いている
